...
printf "\e[1;31m \n1. REGISTER VMNODER \e[0m"
# AreaとVPointを登録
python3 ${PROJECT_PATH}${DIR}/1_register_for_neo4j_vmnoder.py

printf "\e[1;31m \n2. REGISTER PSNODE AND VSNODE \e[0m"
# PSNodeとVSNODEを登録
python3 ${PROJECT_PATH}${DIR}/2_register_for_neo4j_psnode.py
